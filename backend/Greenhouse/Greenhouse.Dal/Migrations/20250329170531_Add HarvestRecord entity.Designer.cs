...
namespace Greenhouse.Dal.Migrations
{
    ...
    [Migration("20250329170531_Add HarvestRecord entity")]
    partial class AddHarvestRecordentity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Greenhouse.Domain.Entities.HarvestRecord", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Greenhouse.Domain.Entities.HarvestRecord", b =>
                {
                    b.HasOne("Greenhouse.Domain.Entities.AgricultiralEvent", "Event")
                        .WithOne()
                        .HasForeignKey("Greenhouse.Domain.Entities.HarvestRecord", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
